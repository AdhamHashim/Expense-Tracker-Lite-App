...
extension TextStyleEx on TextStyle {
  ...
  TextStyle get setThirdColor => copyWith(color: AppColors.mutedGray);
  TextStyle get setForthColor => copyWith(color: AppColors.softBlue);
  TextStyle get setFifthColor => copyWith(color: AppColors.mutedGray);
